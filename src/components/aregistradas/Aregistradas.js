...
export default class Aregistradas extends Component {
  ...
  render () {
    ...
    console.log(martes)
    const miercoles = f.getFullYear() + '-' + meses[f.getMonth()] + '-' + ('0' + (f.getDate() + f.getDay() + 3)).slice(-2)
    console.log(miercoles)
    const jueves = f.getFullYear() + '-' + meses[f.getMonth()] + '-' + ('0' + (f.getDate() + f.getDay() + 4)).slice(-2)
    console.log(jueves)
    const viernes = f.getFullYear() + '-' + meses[f.getMonth()] + '-' + ('0' + (f.getDate() + f.getDay() + 5)).slice(-2)
    console.log(viernes)
    const sabado = f.getFullYear() + '-' + meses[f.getMonth()] + '-' + ('0' + (f.getDate() + f.getDay() + 6)).slice(-2)
    console.log(sabado)
    const domingo = f.getFullYear() + '-' + meses[f.getMonth()] + '-' + ('0' + (f.getDate() + f.getDay()+7)).slice(-2)
    console.log(domingo)
